...
const translations = {
  en: {
    ...
    home: {
      ...
      menuBtn: "Enter Menu",
      guestLimitTitle: "Sign Up Required",
      guestLimitDesc: "Free users can try once.\nSign up to get 1 free recommendation daily!",
      dailyLimitTitle: "Daily Limit Reached",
      dailyLimitDesc: "You've used today's free recommendation.\nUpgrade to PREMIUM for unlimited access!",
      dailyLimitDescBasic: "You've used today's free recommendation.",
      recommendFailTitle: "Recommendation Failed",
      recommendFailDesc: "Failed to generate a recommendation.",
      loginRequired: "Login required for this service.",
    ...
    subscription: {
      ...
      subtitle: "Unlimited drink recommendations for every moment",
      monthly: "Monthly",
      yearly: "Yearly",
      features: "Features",
      paymentMethod: "Payment Method",
      registerPayment: "Register Payment Method",
    ...
    favorites: {
      ...
      premiumDesc: "Favorites are available for PREMIUM members only.",
  ...
  ko: {
    ...
    home: {
      ...
      captureBtn: "요리 촬영하기",
      menuBtn: "메뉴 직접 입력",
      guestLimitTitle: "회원가입 필요",
      guestLimitDesc: "비회원은 1회만 무료로 이용 가능합니다.\n회원가입하시면 매일 1회 무료로 이용할 수 있어요!",
      dailyLimitTitle: "오늘 무료 추천 소진",
      dailyLimitDesc: "오늘의 무료 추천을 모두 사용했습니다.\nPREMIUM으로 업그레이드하시면 무제한으로 이용할 수 있어요!",
      dailyLimitDescBasic: "오늘의 무료 추천을 모두 사용했습니다.",
      recommendFailTitle: "추천 실패",
      recommendFailDesc: "추천을 생성하는데 실패했습니다.",
      loginRequired: "로그인이 필요한 서비스입니다.",
      premiumUpgradeTitle: "PREMIUM 업그레이드",
    },
    capture: {
      title: "요리 촬영",
    ...
    subscription: {
      title: "PREMIUM 구독",
      subtitle: "무제한 음료 추천으로 매 순간을 특별하게",
      monthly: "월간",
      yearly: "연간",
      features: "기능",
      paymentMethod: "결제 수단",
      registerPayment: "결제수단 등록",
      registering: "등록 중...",
      subscribe: "구독하기",
      processing: "처리 중...",
      goBack: "돌아가기",
    ...
    legal: {
      ...
      privacy: "개인정보처리방침",
      payment: "결제/환불 정책",
      lastUpdated: "마지막 업데이트: 2026년 2월 5일",
      goBack: "돌아가기",
    },
    drinks: {
      redWine: "레드 와인",
    ...
    favorites: {
      title: "즐겨찾기",
      noFavorites: "아직 즐겨찾기한 음료가 없습니다.",
      removeFavorite: "즐겨찾기 제거",
      removeConfirm: "즐겨찾기에서 제거하시겠어요?",
      removed: "즐겨찾기에서 제거했습니다.",
      premiumOnly: "PREMIUM 전용 기능",
      premiumDesc: "즐겨찾기는 PREMIUM 멤버만 이용할 수 있습니다.",
      subscribeToPremium: "PREMIUM 구독하기",
      drinkDetails: "음료 상세",
      tastingNotes: "테이스팅 노트",
      details: "상세 정보",
      alcohol: "알코올 도수",
      origin: "원산지",
      servingTemp: "적정 온도",
      recommendedPairing: "추천 페어링",
      purchase: "구매하기",
      error: "오류",
      failedToLoad: "상세 정보를 불러올 수 없습니다.",
      failedToRemove: "제거에 실패했습니다.",
    },
    history: {
      title: "추천 기록",
      noHistory: "아직 추천 기록이 없습니다.",
      viewDetails: "상세 보기",
      createdAt: "생성일",
      detectedFoods: "인식된 음식",
      occasion: "상황",
      tastes: "취향",
      drinks: "추천 음료",
    },
