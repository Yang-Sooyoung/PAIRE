        ...
        <div className="bg-card/50 backdrop-blur-sm border-b border-border sticky top-0 z-10">
          <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
            ...
            <h1 className={cn(
              ...
              {isKorean ? 'Ï∂îÏ≤ú ?àÏä§?†Î¶¨' : 'Recommendation History'}
            </h1>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto px-4 py-12 relative z-10 flex flex-col items-center justify-center min-h-[60vh]">
          ...
          >
            ...
            <h2 className={cn(
              ...
              {isKorean ? 'PREMIUM ?ÑÏö© Í∏∞Îä•' : 'PREMIUM Feature'}
            </h2>
            <p className={cn(
              ...
              {isKorean
                ? 'Ï∂îÏ≤ú ?àÏä§?†Î¶¨??PREMIUM Î©§Î≤ÑÎß??¥Ïö©?????àÏäµ?àÎã§.'
            ...
            >
              {isKorean ? 'PREMIUM Íµ¨ÎèÖ?òÍ∏∞' : 'Subscribe to PREMIUM'}
            </Button>
          </motion.div>
        </div>
      </div>
        ...
        {history.length === 0 ? (
          ...
          >
            ...
            <p className={cn(
              ...
              {isKorean ? '?ÑÏßÅ Ï∂îÏ≤ú Í∏∞Î°ù???ÜÏäµ?àÎã§.' : 'No recommendations yet.'}
            </p>
          </motion.div>
        ) : (
